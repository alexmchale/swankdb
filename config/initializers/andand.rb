# This file is copied into the project to obtain a deprecation warning fix that
# has never made it into the RubyGem.

# http://github.com/raganwald/andand/raw/master/lib/andand.rb
